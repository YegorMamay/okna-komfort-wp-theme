...
if ( ! function_exists( 'yegor_pagination' ) ) {
	function yegor_pagination() {
		global $wp_query;
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fa fa-angle-left"></i> Newer', 'yegor'),
			'next_text' => __('Older <i class="fa fa-angle-right"></i>', 'yegor'),
			'type' => 'list'
		) );
